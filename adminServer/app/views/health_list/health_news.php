            ...
            <div class="col-xs-10">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><span class="glyphicon glyphicon-bullhorn"></span> 养生常识管理</h3>
                    </div>
                    <div class="panel-body">
                        <div style="margin-bottom: 10px;">
                            <a href="<?php echo site_url('health_list/add'); ?>" class="btn btn-primary" role="button"><span class="glyphicon glyphicon-plus"></span> 添加文章</a>
                        </div>
        ...
        function del(_id) {
            ...
            art.dialog({
                ...
                ok: function () {
                    ...
                    $.post("<?php echo site_url('health_list/del') ?>",{_uuid: _id},function(msg){
