            ...
            <div class="col-xs-10">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><span class="glyphicon glyphicon-plus-sign"></span> 添加证书</h3>
                    </div>
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                <label for="title" class="col-sm-2 control-label">证书名称</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="time" name="time" placeholder="请输入考试时间">
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="salary" class="col-sm-2 control-label">预期薪酬</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="salary" name="salary" placeholder="请输入预期薪酬">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    ...
                                    <a href="<?php echo site_url('info_list'); ?>" class="btn btn-default" role="button">返回列表</a>
                                </div>
                            </div>
                        </form>
                    </div>
